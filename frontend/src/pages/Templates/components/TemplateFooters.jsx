...
const TemplateFooters = ({ handleCopy, copiedStates, preview = false }) => {
  const footerTemplates = [
    {
      id: 'footer-1',
      title: 'Modern Business Footer',
      description: 'A clean, responsive footer with logo, links, and newsletter signup',
      price: '$24',
      preview: (
        <div className="w-full h-64 bg-gray-800 text-white p-4 flex flex-col justify-end">
          <div className="flex flex-col sm:flex-row justify-between gap-6">
            <div className="mb-4 sm:mb-0">
              <div className="text-xl font-bold text-violet-400 mb-2">YourBrand</div>
              <p className="text-gray-300 text-sm max-w-xs">Modern solutions for modern businesses. We help you build your digital presence.</p>
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-700 flex flex-col sm:flex-row justify-between items-center">
            <div className="text-sm text-gray-400 mb-3 sm:mb-0">© 2025 YourBrand. All rights reserved.</div>
...
const ModernBusinessFooter = () => {
  return (
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="text-2xl font-bold text-violet-400 mb-4">YourBrand</div>
            <p className="text-gray-300 mb-6">
              Modern solutions for modern businesses. We help you build your digital presence and reach your customers.
            </p>
            <div className="flex space-x-4">
              {/* Social Icons */}
          ...
          <div>
            ...
            <form className="space-y-2">
              <input 
                ...
                className="w-full px-4 py-2 rounded-md bg-gray-700 text-white placeholder-gray-400 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent"
              />
              <button 
                type="submit" 
                className="px-4 py-2 bg-violet-600 hover:bg-violet-700 rounded-md text-white font-medium w-full transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 mb-4 md:mb-0">© 2025 YourBrand. All rights reserved.</p>
...
export default ModernBusinessFooter;`
    }
  ];

  // If preview mode, just show the first template
  const templatesForDisplay = preview ? footerTemplates.slice(0, 1) : footerTemplates;

  return (
    <div className="mb-16" id="footers">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-2xl font-bold dark:text-white">Footer Templates</h2>
        {preview && (
          <a 
            href="#footers" 
            className="text-violet-600 hover:text-violet-700 font-medium flex items-center gap-1"
            onClick={() => document.getElementById('footers')?.scrollIntoView({ behavior: 'smooth' })}
          >
...
export default TemplateFooters;